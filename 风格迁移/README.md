...
Gatys于2015年第一次将VGG19网络应用到风格迁移中[6]。Gatys的关键发现在于：卷积神经网络的内容和风格是分离的，而通过构造Gram矩阵可以提取出任意图像的风格特征表示。
...
每一行分别是训练100、1000、5000和10000轮后的效果，分别对应上述3张风格图片。![图像-1684899788195](pictures/图像-1684899788195.png)
...
每一行分别是训练100、500、1000和4000轮后的效果，分别对应上述3张风格图片。![图像-1684900486257](pictures/图像-1684900486257.png)
